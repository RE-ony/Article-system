		...
		if (T.params = i, T.originalParams = f, T.classNames = [], void 0 !== e && void 0 !== t && (e = t), (
			...
			T.container[0].swiper = T, T.container.data("swiper", T), T.classNames.push(T.params
				...
				function() {
					...
					if (void 0 !== T.size) {
						...
						T.params.slidesPerColumn > 1 && (n = Math.floor(T.slides.length / T.params
							.slidesPerColumn) === T.slides.length / T.params.slidesPerColumn ? T.slides.length :
					...
					for (a = 0; a < T.slidesGrid.length; a++) void 0 !== T.slidesGrid[a + 1] ? s >= T.slidesGrid[
						a] && s < T.slidesGrid[a + 1] - (T.slidesGrid[a + 1] - T.slidesGrid[a]) / 2 ? e = a : s >= T
				...
				.setBreakpoint();
					...
					if (T.params.freeMode) {
						...
						1) && T.isEnd && !T.params.centeredSlides ? T.slideTo(T.slides.length - 1, 0, !1, !0) : T
			...
			T.onTouchStart = function(a) {
				...
				"auto" !== T.params.slidesPerView || T.params.loopedSlides || (T.params.loopedSlides = a
					.length), T.loopedSlides = parseInt(T.params.loopedSlides || T.params.slidesPerView, 10), T
						...
						for (var s = 0; s < T.slides.length; s++) {
							...
							if (o <= 1 && o > -1 && (t = 90 * s + 90 * o, T.rtl && (t = 90 * -s - 90 * o)),
								...
								0 === c.length && (c = e('<div class="swiper-slide-shadow-' + (T
									...
									.isHorizontal() ? "right" : "bottom") + '"></div>'), i.append(m)), c
				...
				loadImageInSlide: function(a, t) {
					if (void 0 !== a && (void 0 === t && (t = !0), 0 !== T.slides.length)) {
						...
						!s.hasClass(T.params.lazyLoadingClass) || s.hasClass(T.params
							.lazyStatusLoadedClass) || s.hasClass(T.params.lazyStatusLoadingClass) || (i = i
			...
			return T.callPlugins = function(e) {
				...
				.destroy(), T.params.keyboardControl && T.disableKeyboardControl && T.disableKeyboardControl(),
