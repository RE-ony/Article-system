...
if (is_uploaded_file($_FILES['file']['tmp_name'])) {
	...
	$file_path="D:/phpstudy_pro/WWW/php/title_cartoon/".date("Ymd");
	$id="";
	...
	$arr[]=$file_path_name;
	$fileAllPath="http://localhost/php/title_cartoon/".$file_path_name;
	...
	if ($error == 0) {
		...
		$result=mysqli_query($link,"insert into arcticle_title values('$id','$uName','$name','$file_name','$arctileId','$fileAllPath','$fileTruePath') ");
		mysqli_close($link);
	} elseif ($error == 1) {
